...
const promiseTimeout = registry.getLiquidConfig().storage.promiseTimeout;
class DbAccess {
    constructor() {
        this.log = registry.getLogger();
    }
    ...
    syncUpdateDocument(model, filter, content) {
        ...
        }, promiseTimeout, "syncUpdateDocument timeout");
    }
    ...
    syncFindDocument(model, filter) {
        ...
        }, promiseTimeout, "syncFindDocument timeout");
    }
